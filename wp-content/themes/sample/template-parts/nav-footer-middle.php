...
$menu_items = wp_get_nav_menu_items('nav-footer-middle');
...
$end = end(array_filter(explode('/', $menu_item['url'])));
if ($parent_slug === $end) {
    array_push($classes, "current");
}
?>
<div class="large-3 medium-6 cell">
    ...
    <nav class="nav-thin">
        <ul class="menu vertical">
            <li class="heading"><?php echo translateText($menu_item['title'], $lang); ?></li>
...
<div class="large-3 medium-6 cell">
    ...
    <nav class="nav-thin">
        <ul class="menu vertical">
            <li class="heading">Speeches</li>
            <li><a href="#">Lectures</a></li>
            <li><a href="#">Presentations</a></li>
            <li><a href="#">Tun Ismail Ali Chair Public Lecture</a></li>
            <li><a href="#">SFC Hong Kong, 1998 - 2005</a></li>
            <li><a href="#">HKMA, 1994 - 1998</a></li>
        </ul>
    </nav>
