...
$menu_items = wp_get_nav_menu_items('nav-footer-right');
...
<ul class="menu vertical">
    ...
    ?>
    <li<?php if (count($classes) > 0){ ?> class="<?php echo implode(' ', array_unique($classes)); ?>"<?php } ?>><a href="<?php echo $menu_item['url'];?>"><?php echo translateText($menu_item['title'], $lang); ?></a>
    </li>
    <?php } ?>
</ul>
<?php } ?>
