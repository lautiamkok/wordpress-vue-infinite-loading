<?php
/**
 * Displays content for books page
 *
 * @package WordPress
 * @subpackage Andrew
 * @since 1.0
...
<div id="api-posts" class="row row-list" data-filter="">
    ...
    <div data-posts-endpoint="<?php echo $endpoint; ?>">
        <?php
        // JSON API endpoint.
        $endpoint = site_url() . '/wp-json/books/v1/lang/' . $langForApi . '/parent/' . $post->ID .'/page/';
        ?>
        ...
        <?php get_template_part( 'template-parts/page/vue', 'books' ); ?>
    </div>
    <!-- vue template -->
