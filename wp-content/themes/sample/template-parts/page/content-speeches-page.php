<?php
/**
 * Displays content for speeches page
 *
 * @package WordPress
 * @subpackage Andrew
 * @since 1.0
...
<div id="api-posts" class="row row-list" data-filter="">
    ...
    <?php
    // JSON API endpoint.
    $endpoint = site_url() . '/wp-json/speeches/v1/lang/' . $langForApi . '/keywords/';
            ...
            <div class="grid-x grid-padding-x align-stretch">
                ...
                <div class="large-9 medium-6 cell">
                    ...
                    <div data-posts-endpoint="<?php echo $endpoint; ?>">
                        <?php
                        // JSON API endpoint.
                        $endpoint = site_url() . '/wp-json/speeches/v1/lang/' . $langForApi . '/parent/' . $post->ID .'/page/';
                        ?>
                        ...
                        <?php
                        // JSON API endpoint.
                        $endpoint = site_url() . '/wp-json/speeches/v1/lang/' . $langForApi . '/year/';
                        ?>
                        ...
                        <?php get_template_part( 'template-parts/page/vue', 'speeches' ); ?>
                    </div>
                    <!-- vue template -->
