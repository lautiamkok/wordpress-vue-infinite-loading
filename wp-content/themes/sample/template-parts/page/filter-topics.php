...
<?php if (count($categories) > 0) { ?>
    ...
    ?>
    <li<?php if (count($classes) > 0){ ?> class="child <?php echo implode(' ', array_unique($classes)); ?>"<?php } ?>><a href="<?php echo $category_url; ?>" data-cat="<?php echo $category->slug; ?>" v-on:click.prevent="filterByCat"><?php echo translateText($category->name, $lang); ?></a></li>
    <?php } ?>
<?php } ?>
