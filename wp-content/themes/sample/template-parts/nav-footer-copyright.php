...
<?php if (count($items) > 0) { ?>
    ...
    ?>
    <li<?php if (count($classes) > 0){ ?> class="hide-for-small-only <?php echo implode(' ', array_unique($classes)); ?>"<?php } ?>><span class="bold"><a href="<?php echo $menu_item['url'];?>"><?php echo translateText($menu_item['title'], $lang); ?></a></span>
    </li>
    <?php } ?>
<?php } ?>
